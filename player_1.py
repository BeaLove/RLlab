    ...
    def random_agent(self):
        ...
        while episode <= self.episode_max:
            ...
            while not end_episode:
                ...
                n[s_current][action] += 1 #when a random choice has been made, increment counter by 1
                # added to the array of states and actions
                # QUESTION: THERE MAY NOT BE 4 POSSIBLE ACTIONS IN EVERY STATE.
                # ADD YOUR CODE SNIPPET BETWEEN EX. 1.2
                #self.action_list is a list of strings
                action_str = self.action_list[action]
                msg = {"action": action_str, "exploration": True}
                self.sender(msg)
